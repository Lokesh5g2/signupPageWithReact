        ...
        <Box sx={{ width: '100%' }}>
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                <Tabs value={value} onChange={handleChange} aria-label="basic tabs example"
                    indicatorColor="none" textColor="inherit" variant="fullWidth" style={{ height: '50px' }} >
                    ...
                    <Tab icon={<Filter3OutlinedIcon />} iconPosition="start" label="Employment Details" {...a11yProps(2)} style={{ fontSize: "9px" }} />
                </Tabs>
            </Box>
